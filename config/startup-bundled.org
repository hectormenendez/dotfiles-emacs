...
These settings are initially defined in [[https://github.com/emacs-mirror/emacs/blob/master/lisp/startup.el][startup.el]]
#+BEGIN_SRC emacs-lisp
  (setq
...
Show how much time it took to Emacs to initialize
#+BEGIN_SRC emacs-lisp
